...
rm -rf  /var/www/$APP_NAME/laravel/vendor
cd "/var/www/$APP_NAME/laravel" || exit 1
sudo -su docker composer install
chown -R 1000:www-data  /var/www/$APP_NAME/laravel/storage /var/www/$APP_NAME/laravel/bootstrap/cache
chmod -R 775  /var/www/$APP_NAME/laravel/storage /var/www/$APP_NAME/laravel/bootstrap/cache
